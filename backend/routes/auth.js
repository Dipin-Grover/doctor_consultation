...
router.post(
  ...
  async (req, res) => {
    try {
      console.log("👉 Incoming patient register body:", req.body);
      ...
      console.error("🔥 PATIENT REGISTER ERROR FULL:", error);
      return res.serverError(error.message || "Registration failed");
    }
  }
);
