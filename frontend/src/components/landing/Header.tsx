...
// Navigate to Settings safely
const goToSettings = () => {
  if (!user?.type) return;

  router.push(`/${user.type}/settings`);
};
          ...
          <div className="flex items-center space-x-4">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56">
                ...
                <DropdownMenuSeparator />
                <DropdownMenuItem onClick={goToProfile} className="flex items-center">
  <User className="w-4 h-4 mr-2" />
  Profile
</DropdownMenuItem>

                <DropdownMenuSeparator />
                <DropdownMenuItem onClick={goToSettings} className="flex items-center">
